--[[
	Prediction Library (advanced build)
	Adaptive projectile prediction: latency compensation, per-target motion
	learning (strafe/turn/jump/knockback), and hit-graded self-tuning.
]]
local module = {}
local eps = 1e-9
