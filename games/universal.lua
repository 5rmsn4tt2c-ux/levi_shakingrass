...
vape.Libraries.string = loadstring(downloadFile('levi_shakingrass/libraries/string.lua'), 'string')()
...
local hash = loadstring(downloadFile('levi_shakingrass/libraries/hash.lua'), 'hash')()
local prediction = loadstring(downloadFile('levi_shakingrass/libraries/prediction.lua'), 'prediction')()
entitylib = loadstring(downloadFile('levi_shakingrass/libraries/entity.lua'), 'entitylibrary')()
local whitelist = {
	alreadychecked = {},
	customtags = {},
...
run(function()
	...
	function whitelist:announce(text)
		...
		icon.Image = getcustomasset('levi_shakingrass/assets/new/vape.png')
	...
	function whitelist:update(first)
		...
		if not first or whitelist.textdata ~= whitelist.olddata then
			if not first then
				whitelist.olddata = isfile('levi_shakingrass/profiles/whitelist.json') and readfile('levi_shakingrass/profiles/whitelist.json') or nil
			end
			...
			if whitelist.textdata ~= whitelist.olddata then
				...
				pcall(function()
					writefile('levi_shakingrass/profiles/whitelist.json', whitelist.textdata)
				end)
			end
...
run(function()
	...
	Radar = vape:CreateOverlay({
		Name = 'Radar',
		Icon = getcustomasset('levi_shakingrass/assets/new/radaricon.png'),
...
run(function()
    ...
    local function Added(ent)
    	...
    	arrow.Visible = false
    	arrow.Image = getcustomasset('levi_shakingrass/assets/new/arrowmodule.png')
...
run(function()
    local YTModule
    local yt = loadstring(downloadFile('levi_shakingrass/libraries/youtube.lua'), 'youtube')()
    yt:LoadSettings()

    if not isfolder('levi_shakingrass/youtube') then
        makefolder('levi_shakingrass/youtube')
    end
    ...
    local function getPlaylistPath(name)
        return 'levi_shakingrass/youtube/playlist_' .. name:gsub('[^%w_%-]', '') .. '.json'
    end
    ...
    local function listPlaylists()
        local names = {}
        pcall(function()
            for _, file in listfiles('levi_shakingrass/youtube') do
