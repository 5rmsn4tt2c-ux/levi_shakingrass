...
run(function()
        ...
        Function = function(callback)
            if callback then
                ...
                repeat
                    ...
                    -- Sticky lock: stay on the same block until it's gone, skip route re-evaluation
    ...
    StickyLock = KingDraco:CreateToggle({
        Name = 'Sticky lock',
        Tooltip = 'Once locked onto a block, keeps breaking it until destroyed — never switches mid-break'
    })
